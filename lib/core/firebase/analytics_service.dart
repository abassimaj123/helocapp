...
class AnalyticsService {
  ...
  Future<void> logDrawScheduleViewed() async {
    if (kDebugMode) return;
    await _a.logEvent(name: 'draw_schedule_viewed');
  }

  Future<void> logHistorySaved() async {
    if (kDebugMode) return;
    await _a.logEvent(name: 'history_saved');
  }

  Future<void> logHistoryViewed() async {
    if (kDebugMode) return;
    await _a.logEvent(name: 'history_viewed');
  }

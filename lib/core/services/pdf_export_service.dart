  ...
  static Future<void> exportHeloc({
    ...
    pdf.addPage(pw.Page(
      ...
      build: (_) => _buildPage(
        ...
        homeEquity: homeEquity, creditLine: creditLine,
        rate: rate, drawPhaseMonths: drawPhaseMonths,
    ...
    await Printing.sharePdf(
      ...
      filename: 'HELOC_${creditLine.round()}_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
  }

  static pw.Widget _buildPage({
    required double homeValue, required double mortgageBalance,
    required double homeEquity, required double creditLine,
    required double rate, required double drawPhaseMonths,
    required double repaymentMonths, required double interestOnlyPayment,
    required double repaymentPayment, required double totalInterest,
  }) {
    ...
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
      ...
      pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
        pw.Expanded(child: pw.Column(children: [
          _sectionBox('HOME EQUITY', [
            ...
            _row2('Home Equity',      _cur0.format(homeEquity), bold: true, color: _teal),
          ...
          _sectionBox('HELOC TERMS', [
            ...
            _row2('Repayment Phase',  '${repaymentMonths.toStringAsFixed(0)} months'),
          ]),
        ])),
        ...
        pw.Expanded(child: pw.Column(children: [
          _sectionBox('PAYMENT BREAKDOWN', [
            ...
            _row2('Repayment Payment',        _cur2.format(repaymentPayment), bold: true, color: _navy),
      ...
      pw.Column(children: [
        ...
        pw.Text('Generated by HELOC Calculator · For illustration purposes only. Not financial advice.',
    ...
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(width: double.infinity, child: ElevatedButton.icon(
          ...
          label: const Text('Premium — \$2.99 (unlimited)', style: TextStyle(fontWeight: FontWeight.bold)),

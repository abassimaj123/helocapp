...
class _CrossPromoCardState extends State<CrossPromoCard> {
  ...
  static const _prefKey       = 'cross_promo_dismissed_helocapp';
  static const _targetName    = 'Home Affordability';
  static const _targetTagline   = 'How much home can you afford?';
  static const _targetTaglineEs = '¿Cuánta casa puedes pagar?';

  static const _targetId      = 'com.calcwise.affordabilityus';
  static const _accentColor   = Color(0xFF1B3A6B);
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: Icon(Icons.house_outlined, color: _accentColor, size: 22),
        ),
